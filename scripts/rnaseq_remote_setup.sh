...
# Usage: /fold/home/shaohua/evoprojects/rnaseq-analysis-plugin/scripts/rnaseq-run -c config.yaml --steps 1a-5b
...
# Usage: cd ~/my-project && /fold/home/shaohua/evoprojects/rnaseq-analysis-plugin/scripts/rnaseq-init-project
SCRIPT_DIR="\$(cd "\$(dirname "\$0")" && pwd)"
