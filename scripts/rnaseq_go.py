#!/usr/bin/env python3
"""Run GO Enrichment (step 3b).

Usage:
    python rnaseq_go.py -c configs/analysis_case.yaml
    python rnaseq_go.py -c configs/analysis_case.yaml --dry-run
"""
import argparse
import os
import sys
...
from scripts.steps.go_enrichment import run


def main():
    parser = argparse.ArgumentParser(description="GO Enrichment (step 3b)")
    ...
    if args.dry_run:
        print("[DRY RUN] Would run step 3b: GO Enrichment")
        return
